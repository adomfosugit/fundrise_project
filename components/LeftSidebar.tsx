...
const LeftSidebar = () => {
  ...
  return (
    ...
    <nav className='  fixed top-0 left-0 hidden  md:flex px-6 py-10 flex-col justify-between min-w-[270px] shadow-2xl h-screen text-gray-800 text-lg font-bold  bg-white'>
